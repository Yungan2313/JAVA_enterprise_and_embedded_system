...
public class BouncingBalls_alt extends JPanel implements MouseListener {
...
//    private Ball ball;
    ...
    public BouncingBalls_alt(int width, int height) {
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                f.setContentPane(new BouncingBalls_alt(500, 500));
                f.pack();
                f.setVisible(true);
            }
        });
